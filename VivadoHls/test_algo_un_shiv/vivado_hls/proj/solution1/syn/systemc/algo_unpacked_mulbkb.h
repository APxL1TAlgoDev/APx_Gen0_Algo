...
#ifndef __algo_unpacked_mulbkb__HH__
#define __algo_unpacked_mulbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(algo_unpacked_mulbkb) {
    ...
    SC_CTOR(algo_unpacked_mulbkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
