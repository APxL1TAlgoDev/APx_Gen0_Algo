...
#pragma HLS UNROLL
		link_out_2d[lnk][0].range(31, 0)  = link_in_2d[lnk][0].range(31,  0) + 1;
		link_out_2d[lnk][0].range(63, 32) = link_in_2d[lnk][0].range(63, 32) + 2;
		link_out_2d[lnk][1].range(31,  0) = link_in_2d[lnk][1].range(31,  0) + 3;
		link_out_2d[lnk][1].range(63, 32) = link_in_2d[lnk][1].range(63, 32) + 4;
		link_out_2d[lnk][2].range(31,  0) = link_in_2d[lnk][2].range(31,  0) + 5;
		link_out_2d[lnk][2].range(63, 32) = link_in_2d[lnk][2].range(63, 32) + 6;
	}
}
